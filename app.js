/**
 * /**
 * Raziye hanim bizden bir online satis sitesi olusturmamizi istiyor
 * Raziye hanim urun listesinin sol tarafta,sepete eklenen urunlerin ise sag tarafta gozukmesini istiyor.
 * olusturulan bir buton ile urun listesinden urunu sepete ekleyebilecek,baska bir buton ile de sepetten silebilecegiz
 * sepetin en altinde ise kullanicinin giris yaptigi urunlerin fiyatlarinin toplami olacak
 * Bu odev de fonsiyonlari kullanacagiz bu fonksiyonlari DOM API uzerinden olusturdugumuz html elementlerine atayacagiz.
 * Kullanici ekle tusuna bastiginde urun sepete gecicek sil tusuna bastiginda da urun sepetten cikacak
 * kullanici butonlara bastiginda total price kutusu guncel olacak ve o an sepette bulunan urunlerin toplam fiyatini gosterecek
 * kullanici bir urunden iki tane isterse urun sepette iki defa gececek
 * 
 */
...
let priceList = [];
let count = 0;
const mainList = document.querySelector("#product-list")
const reducer = (accumulator, currentValue) => accumulator + currentValue;
const totalInput = document.getElementById("price-clear")
const counterButton = document.getElementById("counter")
const shoppingList = document.querySelector("#shop-list")
